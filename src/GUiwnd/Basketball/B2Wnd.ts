/**篮球 让分胜负 */
class B2Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: B2Wnd;
	public static get getInstance(): B2Wnd {
    ...
    private _item:GHashMap<B2infoTop>;

    constructor(){
        super();
        this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<B2infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<B2infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = BasketballDataMrg.getInstance.getDGList(2);
        let objHeight=0;
