/**篮球 胜负 */
class B3Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: B3Wnd;
	public static get getInstance(): B3Wnd {
    ...
    private _item:GHashMap<B3infoTop>;

    constructor(){
        super();
        this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<B3infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<B3infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = BasketballDataMrg.getInstance.getDGList(3);
        let objHeight=0;
