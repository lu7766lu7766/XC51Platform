/**篮 串关 */
class B5infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<B5info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        ...
        this._item = new GHashMap<B5info_subInfo>();
    ...
    public getSubItem():GHashMap<B5info_subInfo>{
        return this._item;
    }
...
class B5info_subInfo extends egret.DisplayObjectContainer{
