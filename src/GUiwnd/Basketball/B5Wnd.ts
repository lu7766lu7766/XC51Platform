/**篮球 胜分差 */
class B5Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: B5Wnd;
	public static get getInstance(): B5Wnd {
    ...
    private _item:GHashMap<B5infoTop>;

    constructor(){
        super();
        this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<B5infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<B5infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = BasketballDataMrg.getInstance.getDGList(5);
        let objHeight=0;
