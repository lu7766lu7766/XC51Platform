/**半全场 */
class G5Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: G5Wnd;
	public static get getInstance(): G5Wnd {
	...
	private _item:GHashMap<G5infoTop>;

    constructor(){
        super();
		this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<G5infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<G5infoTop>{
        return this._item;
    }
    /**暂无数据提示 */
	...
	public updata():void{
        ...
        let item = FootballDataMrg.getInstance.getDGList(5);
        let objHeight=0;
