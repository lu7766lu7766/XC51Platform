/**足 进球数 */
class G3infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<G3info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        ...
        this._item = new GHashMap<G3info_subInfo>();
    ...
    public getSubItem():GHashMap<G3info_subInfo>{
        return this._item;
    }
...
class G3info_subInfo extends egret.DisplayObjectContainer{
