/**胜平负 */
class G2Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: G2Wnd;
	public static get getInstance(): G2Wnd {
	...
	private _item:GHashMap<G2infoTop>;

    constructor(){
        super();
		this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<G2infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<G2infoTop>{
        return this._item;
    }
    /**暂无数据提示 */
	...
	public updata():void{
        ...
        let item = FootballDataMrg.getInstance.getDGList(2);
        let objHeight=0;
