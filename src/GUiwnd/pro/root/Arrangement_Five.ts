 ...
 */
class Arrangement_Five implements IProHandle {
	private static _mInstance: Arrangement_Five;
	public static get getInstance(): Arrangement_Five {
	...
	public sendHttp(list:Array<InjectionCode>,bs:number,czType:string): void {
		let url: string = HTTPRequest.getInstance.httpHeadUrl + "/Arrangement_Five.php";
		let a = new Array();
		let zs:number = 0;
		let m:number = 0;
