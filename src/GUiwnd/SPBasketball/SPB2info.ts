/**篮 串关 */
class SPB2infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<SPB2info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        ...
        this._item = new GHashMap<SPB2info_subInfo>();
    ...
    public getSubItem():GHashMap<SPB2info_subInfo>{
        return this._item;
    }
...
class SPB2info_subInfo extends egret.DisplayObjectContainer{
    ...
    constructor(){
        ...
        let zhu = ToolMrg.getText(394,77,24,0xf72e52);
        this.addChild(zhu);
        zhu.text = "主";
