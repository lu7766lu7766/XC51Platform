/**篮球 胜负 */
class SPB3Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: SPB3Wnd;
	public static get getInstance(): SPB3Wnd {
    ...
    private _item:GHashMap<SPB3infoTop>;

    constructor(){
        super();
        this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<SPB3infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<SPB3infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = BasketballDataMrg.getInstance.getCJDGList(3);
        let objHeight=0;
