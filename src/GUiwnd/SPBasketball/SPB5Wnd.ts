/**篮球 胜分差 */
class SPB5Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: SPB5Wnd;
	public static get getInstance(): SPB5Wnd {
    ...
    private _item:GHashMap<SPB5infoTop>;

    constructor(){
        super();
        this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<SPB5infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<SPB5infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = BasketballDataMrg.getInstance.getCJDGList(5);
        let objHeight=0;
