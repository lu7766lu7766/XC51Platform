/**篮 串关 */
class SPB4infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<SPB4info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        ...
        this._item = new GHashMap<SPB4info_subInfo>();
    ...
    public getSubItem():GHashMap<SPB4info_subInfo>{
        return this._item;
    }
...
class SPB4info_subInfo extends egret.DisplayObjectContainer{
