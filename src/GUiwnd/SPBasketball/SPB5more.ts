/**更多玩法 串关 篮球 */
class SPB5more extends egret.DisplayObjectContainer{
    private static _mInstance: SPB5more;
	public static get getInstance(): SPB5more {
    ...
    private joinBlock():void{
        ...
        //4 - 9
        for(let i=4;i<10;i++){
            let obj = new SPBasketballBlock(i,1,100,100,1);
