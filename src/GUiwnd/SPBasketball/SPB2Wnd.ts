/**篮球 让分胜负 */
class SPB2Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: SPB2Wnd;
	public static get getInstance(): SPB2Wnd {
    ...
    private _item:GHashMap<SPB2infoTop>;

    constructor(){
        super();
        this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<SPB2infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<SPB2infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = BasketballDataMrg.getInstance.getCJDGList(2);
        let objHeight=0;
