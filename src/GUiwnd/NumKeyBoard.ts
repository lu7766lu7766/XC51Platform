...
class NumKeyData{
    ...
    public str:string;
    /**传入文本 */
    public strText:egret.TextField;
    /**点击前当前对象类(this) */
    thisObj: any;
    /**点击完成回调方法 */
	backFun: Function;
...
/**数字键盘 */
class NumKeyBoard extends egret.DisplayObjectContainer{
    private static _mInstance: NumKeyBoard;
    public static get getInstance(): NumKeyBoard {
    ...
    private topStr = [5,10,50,100,200];
    private _topItem:GHashMap<NumKeyBoardTopInfo>;

    private numStr = [1,2,3,4,5,6,7,8,9,0];
    private _numItem:GHashMap<NumKeyBoardBtnInfo>;
    ...
    constructor(){
        ...
        this._topItem = new GHashMap<NumKeyBoardTopInfo>();
        this._numItem = new GHashMap<NumKeyBoardBtnInfo>();
...
/**头部info按钮模块 */
class NumKeyBoardTopInfo extends egret.DisplayObjectContainer{
...
/** 0~9按钮 */
class NumKeyBoardBtnInfo extends egret.DisplayObjectContainer{
