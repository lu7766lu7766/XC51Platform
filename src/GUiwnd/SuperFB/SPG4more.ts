/**更多玩法 比分 */
class SPG4more extends egret.DisplayObjectContainer{
    private static _mInstance: SPG4more;
	public static get getInstance(): SPG4more {
    ...
    private joinSPBlock():void{
        ...
        let bjTop=0;
        for(let i=6;i<18;i++){
            let obj = new SPBlock(i,120,62,null,null,1);
        ...
        //18
        let obj18 = new SPBlock(18,368,62,null,null,1);
        obj18.x = 326;
        obj18.y = 250;
        ...
        //36
        let obj36 = new SPBlock(36,368,62,null,null,1);
        obj36.x = 326;
        obj36.y = 514;
