/**进球数 */
class SPG3Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: SPG3Wnd;
	public static get getInstance(): SPG3Wnd {
	...
	private _item:GHashMap<SPG3infoTop>;

    constructor(){
        super();
		this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<SPG3infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<SPG3infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = FootballDataMrg.getInstance.getCJDGList(3);
        let objHeight=0;
