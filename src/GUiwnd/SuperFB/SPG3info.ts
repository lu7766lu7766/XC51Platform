/**足 进球数 */
class SPG3infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<SPG3info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        ...
        this._item = new GHashMap<SPG3info_subInfo>();
    ...
    public getSubItem():GHashMap<SPG3info_subInfo>{
        return this._item;
    }
...
class SPG3info_subInfo extends egret.DisplayObjectContainer{
