/**半全场 */
class SPG5Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: SPG5Wnd;
	public static get getInstance(): SPG5Wnd {
	...
	private _item:GHashMap<SPG5infoTop>;

    constructor(){
        super();
		this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<SPG5infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<SPG5infoTop>{
        return this._item;
    }
    /**暂无数据提示 */
	...
	public updata():void{
        ...
        let item = FootballDataMrg.getInstance.getCJDGList(5);
        let objHeight=0;
