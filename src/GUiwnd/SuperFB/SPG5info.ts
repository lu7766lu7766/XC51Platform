/**足 半全场 */
class SPG5infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<SPG5info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        super();
        this._item = new GHashMap<SPG5info_subInfo>();
    ...
    public getSubItem():GHashMap<SPG5info_subInfo>{
        return this._item;
    }
...
class SPG5info_subInfo extends egret.DisplayObjectContainer{
    ...
    constructor(){
        ...
        //49
        let obj49 = new SPBlock(49,110,128,41,70,null,1);
        this.addChild(obj49);
