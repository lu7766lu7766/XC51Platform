/**竞彩足球开奖详情item */
class jcFootBallItem extends egret.DisplayObjectContainer implements GIObjPool {
	public static getObj(): jcFootBallItem {
		let obj = GObjPool.getInstance.GgetObj(jcFootBallItem);
		if (obj == null)
	...
	private _mData: JCFootBallData;
	public setID(data: JCFootBallData): void {
		this._mData = data;
		this.initallInfo();
		this.setteamandBF();
...
class xianxian extends egret.DisplayObjectContainer {
	public constructor(id: number) {
		...
		this.rightline1.graphics.drawRect(133, 0, 1, 50);
		...
		this.rightline2.graphics.drawRect(133, 10, 1, 32);
		this.rightline2.graphics.endFill();

		this.connet = ToolMrg.getText(0, 0, 24, 0x333333, 134);
