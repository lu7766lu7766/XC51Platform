/**篮球和足球跟单详情 */
class fagxMrgView extends egret.DisplayObjectContainer {
	private static _mInstance: fagxMrgView;
	public static get getInstance(): fagxMrgView {
	...
	private mtext7Img: egret.Bitmap;//vip背景
	private vipLv: egret.TextField;//vipLv等级
	/**复制按钮 */
	...
	private mtext3:egret.TextField;

	/**订单状态 */
	private _codeType: egret.TextField;

	private _fsText:egret.TextField;//返水
	private _gdawareText1: egret.TextField;//跟单奖金数量text
	private _gdawareText2: egret.TextField;//抽佣比例数量text
	private _gdawareText3: egret.TextField;//抽佣金额数量text
	/**底部 */
	public downObj:TwofaView;
	...
	private init(): void {
		...
		let dd = ToolMrg.getText(158, 384, 24, 0x333333);
		...
		let mtext6 = ToolMrg.getText(28, 480, 24, 0x999999);
		this._mContain.addChild(mtext6);
		mtext6.height = 34;
		mtext6.verticalAlign = egret.VerticalAlign.MIDDLE;
		mtext6.text = "发单人：";

		let mtext7 = ToolMrg.getText(76, 560+13, 24, 0x999999);
		this._mContain.addChild(mtext7);
		mtext7.text = "跟单奖金";

		let mtext8 = ToolMrg.getText(0, 560+13, 24, 0x999999);
		this._mContain.addChild(mtext8);
		mtext8.width = 750;
		mtext8.textAlign = egret.HorizontalAlign.CENTER;
		mtext8.text = "抽佣比例";

		let mtext9 = ToolMrg.getText(582, 560+13, 24, 0x999999);
		...
		let link6 = new egret.Bitmap();
		this._mContain.addChild(link6);
		link6.x = 250;
		link6.y = 536;
		link6.height = 60;
		link6.width = 3;
		RES.getResByUrl("resource/assets/images/ui/hui.png", (e) => { link6.$setBitmapData(e); }, this);

		let link7 = new egret.Bitmap();
		this._mContain.addChild(link7);
		link7.x = 500;
		link7.y = 536;
		link7.height = 60;
		link7.width = 3;
		RES.getResByUrl("resource/assets/images/ui/hui.png", (e) => { link7.$setBitmapData(e); }, this);
		...
		RES.getResByUrl("resource/assets/images/ui/hydj_expert@2x.png", (e) => {
