class SPBkExplain extends egret.DisplayObjectContainer{
    private static _mInstance: SPBkExplain;
    public static get getInstance(): SPBkExplain {
    ...
    constructor(){
        ...
        this._topUI = new TopUI("超级篮彩玩法介绍");
