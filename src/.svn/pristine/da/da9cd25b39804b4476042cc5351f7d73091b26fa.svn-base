class SPFbExplain extends egret.DisplayObjectContainer{
    private static _mInstance: SPFbExplain;
    public static get getInstance(): SPFbExplain {
    ...
    constructor(){
        ...
        this._topUI = new TopUI("超级足彩玩法介绍");
        ...
        RES.getResByUrl(`resource/assets/images/ui/jczq1.png`,(e)=>{btn1.$setBitmapData(e); },this);
