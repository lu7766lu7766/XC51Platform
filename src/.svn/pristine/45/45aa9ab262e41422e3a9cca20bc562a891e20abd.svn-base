class ListThreeExplain extends egret.DisplayObjectContainer{
    private static _mInstance: ListThreeExplain;
    public static get getInstance(): ListThreeExplain {
    ...
    constructor(){
        ...
        RES.getResByUrl(`resource/assets/images/ui/pl3sm1.png`,(e)=>{btn1.$setBitmapData(e); },this);

        let btn2 = new egret.Bitmap();
        this._mContain.addChild(btn2);
        btn2.y = 760;
        RES.getResByUrl(`resource/assets/images/ui/pl3sm2.png`,(e)=>{btn2.$setBitmapData(e); },this);
