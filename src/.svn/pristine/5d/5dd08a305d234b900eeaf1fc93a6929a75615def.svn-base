...
class FT_One implements IProHandle {
	...
	private constructor() {
		...
		GTimerMag.getInstance.addTimerTask("FT_One", 9999999, GameValue.httpSendTime, () => {
