/**篮球 大小分 */
class SPB4Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: SPB4Wnd;
	public static get getInstance(): SPB4Wnd {
    ...
    private _item:GHashMap<SPB4infoTop>;

    constructor(){
        super();
        this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<SPB4infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<SPB4infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = BasketballDataMrg.getInstance.getCJDGList(4);
        let objHeight=0;
