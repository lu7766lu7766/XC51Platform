class ListFiveExplain extends egret.DisplayObjectContainer{
    private static _mInstance: ListFiveExplain;
    public static get getInstance(): ListFiveExplain {
    ...
    constructor(){
        ...
        RES.getResByUrl(`resource/assets/images/ui/pl5sm.png`,(e)=>{btn1.$setBitmapData(e); },this);
