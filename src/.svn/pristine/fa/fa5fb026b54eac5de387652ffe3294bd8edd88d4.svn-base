/**足 串关 */
class G1infoTop extends egret.DisplayObjectContainer {
    ...
    /**子类info */
    private _item:GHashMap<G1info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        super();
        this._item = new GHashMap<G1info_subInfo>();
    ...
    public getSubItem():GHashMap<G1info_subInfo>{
        return this._item;
    }
...
class G1info_subInfo extends egret.DisplayObjectContainer{
