/**篮 串关 */
class B4infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<B4info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        ...
        this._item = new GHashMap<B4info_subInfo>();
    ...
    public getSubItem():GHashMap<B4info_subInfo>{
        return this._item;
    }
...
class B4info_subInfo extends egret.DisplayObjectContainer{
    ...
    constructor(){
        ...
        this._rangeText = ToolMrg.getText(355,104,20,0xf72e52,100);
