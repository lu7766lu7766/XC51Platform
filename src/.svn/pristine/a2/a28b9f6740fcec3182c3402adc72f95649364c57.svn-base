/**进球数 */
class G3Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: G3Wnd;
	public static get getInstance(): G3Wnd {
	...
	private _item:GHashMap<G3infoTop>;

    constructor(){
        super();
		this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<G3infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<G3infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = FootballDataMrg.getInstance.getDGList(3);
        let objHeight=0;
