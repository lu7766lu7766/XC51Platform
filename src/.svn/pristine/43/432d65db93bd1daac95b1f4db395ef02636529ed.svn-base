/**比分 */
class SPG4Wnd extends egret.DisplayObjectContainer{
    private static _mInstance: SPG4Wnd;
	public static get getInstance(): SPG4Wnd {
	...
	private _item:GHashMap<SPG4infoTop>;

    constructor(){
        super();
		this.touchEnabled = true;
        this._mContain = new egret.DisplayObjectContainer();
		this._item = new GHashMap<SPG4infoTop>();

        this.addScoll();
        this.setDB();
    }

    public GetItem():GHashMap<SPG4infoTop>{
        return this._item;
    }
	...
	public updata():void{
        ...
        let item = FootballDataMrg.getInstance.getCJDGList(4);
        let objHeight=0;
