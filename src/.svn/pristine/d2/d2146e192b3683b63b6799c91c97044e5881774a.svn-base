class FbExplain extends egret.DisplayObjectContainer{
    private static _mInstance: FbExplain;
    public static get getInstance(): FbExplain {
    ...
    constructor(){
        ...
        this._topUI = new TopUI("竞彩足球玩法介绍");
