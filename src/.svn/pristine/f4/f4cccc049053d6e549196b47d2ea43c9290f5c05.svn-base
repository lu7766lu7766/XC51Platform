/**足 比分 */
class SPG4infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<SPG4info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        super();
        this._item = new GHashMap<SPG4info_subInfo>();
    ...
    public getSubItem():GHashMap<SPG4info_subInfo>{
        return this._item;
    }
...
class SPG4info_subInfo extends egret.DisplayObjectContainer{
