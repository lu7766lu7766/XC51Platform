/**篮 串关 */
class SPB3infoTop extends egret.DisplayObjectContainer{
    ...
    /**子类info */
    private _item:GHashMap<SPB3info_subInfo>;
    /**用于列表显示优化当前高度 */
    ...
    constructor(){
        ...
        this._item = new GHashMap<SPB3info_subInfo>();
    ...
    public getSubItem():GHashMap<SPB3info_subInfo>{
        return this._item;
    }
...
class SPB3info_subInfo extends egret.DisplayObjectContainer{
