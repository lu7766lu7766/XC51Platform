/**足球筛选 */
class FBscreen extends egret.DisplayObjectContainer{
    private static _mInstance: FBscreen;
	public static get getInstance(): FBscreen {
