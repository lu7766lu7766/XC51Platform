/**更多玩法 串关 */
class SPG1more extends egret.DisplayObjectContainer{
    private static _mInstance: SPG1more;
	public static get getInstance(): SPG1more {
    ...
    private _item:GHashMap<SPBlock>;
    ...
    constructor(){
        ...
        this._item = new GHashMap<SPBlock>();
    ...
    /**加入块样式 */
    private joinSPBlock():void{
        //0-5
        for(let i=0;i<6;i++){
            let obj = new SPBlock(i,202,56,null,null,0);
        ...
        let bjTop=0;
        for(let i=6;i<18;i++){
            let obj = new SPBlock(i,120,62,null,null,0);
            this._mContain.addChild(obj);
            this._item.Gput(obj.index,obj);
            if(bjTop<5){
                obj.y = 200;
        ...
        //18
        let obj18 = new SPBlock(18,368,62,null,null,0);
        obj18.x = 340;
        obj18.y = 332;
        ...
        //36
        let obj36 = new SPBlock(36,369,62,null,null,0);
        obj36.x = 340;
        obj36.y = 596;
        ...
        //总进球开始 37-44
        for(let i=37;i<45;i++){
            let obj = new SPBlock(i,152,62,null,null,0);
            this._mContain.addChild(obj);
            this._item.Gput(obj.index,obj);
            if(i<41){
                obj.x = 92+156*(i-37);
        ...
        //49
        let obj49 = new SPBlock(49,120,128,40,70,0);
