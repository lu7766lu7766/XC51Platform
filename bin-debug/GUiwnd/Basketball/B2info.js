...
/**篮 串关 */
var B2infoTop = (function (_super) {
    __extends(B2infoTop, _super);
    function B2infoTop() {
    ...
    B2infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    B2infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - B2Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    B2infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    B2infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
        ...
        // B2Wnd.getInstance.changeItemHeight();
        this.changeImg();
        B1Wnd.getInstance.updateYH();
    };
    B2infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    B2infoTop.prototype.addInterception = function () {
    ...
    B2infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    B2infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    B2infoTop.prototype.setDB = function () {
...
__reflect(B2infoTop.prototype, "B2infoTop");
var B2info_subInfo = (function (_super) {
    __extends(B2info_subInfo, _super);
    function B2info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
    ...
    B2info_subInfo.prototype.aa = function (data) {
        this._data = data;
        this.id = data.id;
    ...
    B2info_subInfo.prototype.clear = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).clear();
        }
    };
    B2info_subInfo.prototype.changeText = function (num) {
    };
    /**边 117高度 */
    B2info_subInfo.prototype.addedge = function () {
    ...
    /**适配处理 */
    B2info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    B2info_subInfo.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).removeInterception();
        }
    };
    return B2info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(B2info_subInfo.prototype, "B2info_subInfo");
//# sourceMappingURL=B2info.js.map