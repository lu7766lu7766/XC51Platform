...
/**篮球 串关 */
var B1Wnd = (function (_super) {
    __extends(B1Wnd, _super);
    function B1Wnd() {
    ...
    Object.defineProperty(B1Wnd, "getInstance", {
        get: function () {
    ...
    B1Wnd.prototype.GetItem = function () {
        return this._item;
    };
    B1Wnd.prototype.changeText = function (id, num) {
    ...
    B1Wnd.prototype.updata = function () {
        var _this = this;
    ...
    /**滑动时更新数据 */
    B1Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**之刷新数据 */
    B1Wnd.prototype.onlyFreshData = function () {
        var item = BasketballDataMrg.getInstance._mLQLB;
        var obj;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B1Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B1Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B1Wnd.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    B1Wnd.prototype.change = function (event) {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._item.Gget(key).optimization();
        }
    };
    B1Wnd.prototype.httpUpdata = function (e) {
        if (e.data != undefined) {
            if (e.data.cf == 1) {
    ...
    /**获取滚动位置 */
    B1Wnd.prototype.getViewYYTop = function () {
        return this._scroView.scrollTop;
    };
    B1Wnd.prototype.hide = function () {
    ...
    B1Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    B1Wnd.prototype.setDB = function () {
...
__reflect(B1Wnd.prototype, "B1Wnd");
//# sourceMappingURL=B1Wnd.js.map