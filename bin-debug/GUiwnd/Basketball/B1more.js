...
/**更多玩法 串关 篮球 */
var B1more = (function (_super) {
    __extends(B1more, _super);
    function B1more() {
    ...
    Object.defineProperty(B1more, "getInstance", {
        get: function () {
            if (B1more._mInstance == undefined)
                B1more._mInstance = new B1more();
            return B1more._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    B1more.prototype.show = function (id) {
        ...
        CustEventMrg.getInstance.addEventListener(CustEventType.EventType_BK_List_More, this.upThisValue, this);
    };
    //进入时显示选中
    B1more.prototype.startDataOfCss = function () {
    ...
    B1more.prototype.upThisValue = function () {
        this._numItem.clear();
        var item = BasketballDataMrg.getInstance._mLQLB;
        var data;
        ...
        this._downText.text = "" + data.dxFAll;
    ...
    B1more.prototype.addData = function (index, isSelect) {
        if (isSelect) {
    ...
    B1more.prototype.hide = function () {
    ...
    //hide时清理数值
    B1more.prototype.clearDataOfCss = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    /**适配处理 */
    B1more.prototype.setDB = function () {
    ...
    B1more.prototype.joinBlock = function () {
        //0 - 1
        for (var i = 0; i < 2; i++) {
            var obj = new BasketballBlock(i, 0, 240, 100, 0, 19, 57);
        ...
        //2 - 3
        for (var i = 2; i < 4; i++) {
            var obj = new BasketballBlock(i, 1, 240, 100, 0, 19, 57);
            this._mContain.addChild(obj);
            this._item.Gput(i, obj);
        ...
        //4 - 9
        for (var i = 4; i < 10; i++) {
            var obj = new BasketballBlock(i, 1, 100, 100, 0);
            this._mContain.addChild(obj);
            this._item.Gput(i, obj);
            obj.x = 76 + (i - 4) * (100 + 4);
            obj.y = 256;
    ...
    B1more.prototype.touchDown = function (e) {
    ...
    B1more.prototype.addInterception = function () {
    ...
    B1more.prototype.removeInterception = function () {
...
__reflect(B1more.prototype, "B1more");
//# sourceMappingURL=B1more.js.map