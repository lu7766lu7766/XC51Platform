...
/**更多玩法 串关 篮球 */
var B5more = (function (_super) {
    __extends(B5more, _super);
    function B5more() {
    ...
    Object.defineProperty(B5more, "getInstance", {
        get: function () {
    ...
    B5more.prototype.show = function (id) {
    ...
    //进入时显示选中
    B5more.prototype.startDataOfCss = function () {
    ...
    B5more.prototype.upThisValue = function () {
        this._numItem.clear();
    ...
    B5more.prototype.addData = function (index, isSelect) {
        if (isSelect) {
    ...
    B5more.prototype.hide = function () {
    ...
    //hide时清理数值
    B5more.prototype.clearDataOfCss = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    /**适配处理 */
    B5more.prototype.setDB = function () {
    ...
    B5more.prototype.joinBlock = function () {
        //4 - 9
        for (var i = 4; i < 10; i++) {
            var obj = new BasketballBlock(i, 1, 100, 100, 1);
    ...
    B5more.prototype.touchDown = function (e) {
    ...
    B5more.prototype.addInterception = function () {
    ...
    B5more.prototype.removeInterception = function () {
...
__reflect(B5more.prototype, "B5more");
//# sourceMappingURL=B5more.js.map