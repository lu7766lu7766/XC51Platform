...
/**篮球 胜负 */
var B3Wnd = (function (_super) {
    __extends(B3Wnd, _super);
    function B3Wnd() {
    ...
    Object.defineProperty(B3Wnd, "getInstance", {
        get: function () {
            if (B3Wnd._mInstance == undefined)
                B3Wnd._mInstance = new B3Wnd();
            return B3Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    B3Wnd.prototype.GetItem = function () {
        return this._item;
    };
    B3Wnd.prototype.changeText = function (id, num) {
    ...
    B3Wnd.prototype.updata = function () {
        var _this = this;
        // let item = BasketballDataMrg.getInstance._mLQLBDG;
        var item = BasketballDataMrg.getInstance.getDGList(3);
        var objHeight = 0;
    ...
    /**之刷新数据 */
    B3Wnd.prototype.onlyFreshData = function () {
        var item = BasketballDataMrg.getInstance.getDGList(3);
        var obj;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**滑动时更新数据 */
    B3Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B3Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B3Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B3Wnd.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    B3Wnd.prototype.change = function (event) {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B3Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    B3Wnd.prototype.setDB = function () {
...
__reflect(B3Wnd.prototype, "B3Wnd");
//# sourceMappingURL=B3Wnd.js.map