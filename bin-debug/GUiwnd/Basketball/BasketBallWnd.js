...
/**篮球 */
var BasketBallWnd = (function (_super) {
    __extends(BasketBallWnd, _super);
    function BasketBallWnd() {
    ...
    Object.defineProperty(BasketBallWnd, "getInstance", {
        get: function () {
    ...
    //测试数据
    BasketBallWnd.prototype.test = function () {
        var id = 0;
        for (var i = 0; i < 3; i++) {
            var fb = new GHashMap();
            for (var k = 0; k < 3; k++) {
    ...
    /**获取当前所选数组长度 */
    BasketBallWnd.prototype.getArrSize = function () {
        return this._arr;
    };
    /**more回调 */
    BasketBallWnd.prototype.upChangeSubMore = function (id, data) {
    ...
    /**map转换arr */
    BasketBallWnd.prototype.setitemToArr = function () {
        var arr = [];
    ...
    BasketBallWnd.prototype.changeTextAndData = function (id, index, isboom) {
        if (isboom) {
            var obj = void 0;
    ...
    BasketBallWnd.prototype.changeText = function (id) {
        var num = [];
        if (this.allItem.GhasKey(id)) {
        ...
        if (BasketBallWnd.inIndex == 0) {
            B1Wnd.getInstance.changeText(id, num);
        }
        else if (BasketBallWnd.inIndex == 4) {
            B5Wnd.getInstance.changeText(id, num);
        }
    };
    //投注点击删除
    BasketBallWnd.prototype.ClickRemove = function (id) {
        if (id != undefined) {
            var mitem = void 0;
            if (BasketBallWnd.inIndex == 0) {
                mitem = B1Wnd.getInstance.GetItem();
            }
    ...
    /**清除所有数据 */
    BasketBallWnd.prototype.clearAllData = function () {
        var mitem;
        if (BasketBallWnd.inIndex == 0) {
            mitem = B1Wnd.getInstance.GetItem();
        }
    ...
    BasketBallWnd.prototype.GoChange = function (e) {
    ...
    BasketBallWnd.prototype.touchDown = function (e) {
        if (e.target == this._return) {
            this.hide();
        }
        else if (e.target == this._questions) {
            BkExplain.getInstance.show();
        }
        else if (e.target == this._screen) {
            BasketScreen.getInstance.show();
        }
    };
    /**篮球支付成功回调 关闭支付界面 单开订单*/
    BasketBallWnd.prototype.zfBack = function () {
    ...
    BasketBallWnd.prototype.show = function () {
    ...
    BasketBallWnd.prototype.hide = function () {
        if (this.parent != undefined) {
            ...
            this.clearAllData();
            BtOnePass.getInstance.hide();
            B1Wnd.getInstance.hide();
            if (WorldWnd._worldState == 1) {
                WorldWnd.getInstance.show();
            }
        }
    };
    BasketBallWnd.prototype.topClick = function (e) {
    ...
    BasketBallWnd.prototype.changeTop = function () {
        this.clearAllData();
        if (this._index == 0) {
            ...
            B1Wnd.getInstance.hide();
            BtOnePass.getInstance.show();
            this._downT2.text = "请至少选择1场比赛";
        }
    };
    BasketBallWnd.prototype.addInterception = function () {
    ...
    BasketBallWnd.prototype.removeInterception = function () {
    ...
    BasketBallWnd.prototype.addTop = function () {
        var _this = this;
    ...
    BasketBallWnd.prototype.joinDown = function () {
        var _this = this;
    ...
    /**适配处理 */
    BasketBallWnd.prototype.setDB = function () {
    ...
    BasketBallWnd.inIndex = 0;
    return BasketBallWnd;
}(egret.DisplayObjectContainer));
__reflect(BasketBallWnd.prototype, "BasketBallWnd");
//# sourceMappingURL=BasketBallWnd.js.map