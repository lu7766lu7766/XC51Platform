...
/**篮球 让分胜负 */
var B2Wnd = (function (_super) {
    __extends(B2Wnd, _super);
    function B2Wnd() {
    ...
    Object.defineProperty(B2Wnd, "getInstance", {
        get: function () {
            if (B2Wnd._mInstance == undefined)
                B2Wnd._mInstance = new B2Wnd();
            return B2Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    B2Wnd.prototype.GetItem = function () {
        return this._item;
    };
    B2Wnd.prototype.changeText = function (id, num) {
    ...
    B2Wnd.prototype.updata = function () {
        var _this = this;
        // let item = BasketballDataMrg.getInstance._mLQLBDG;
        var item = BasketballDataMrg.getInstance.getDGList(2);
        var objHeight = 0;
    ...
    /**之刷新数据 */
    B2Wnd.prototype.onlyFreshData = function () {
        var item = BasketballDataMrg.getInstance.getDGList(2);
        var obj;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**滑动时更新数据 */
    B2Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B2Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B2Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B2Wnd.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    /**获取滚动位置 */
    B2Wnd.prototype.getViewYYTop = function () {
        return this._scroView.scrollTop;
    };
    B2Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    B2Wnd.prototype.setDB = function () {
...
__reflect(B2Wnd.prototype, "B2Wnd");
//# sourceMappingURL=B2Wnd.js.map