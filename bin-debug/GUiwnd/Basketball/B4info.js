...
/**篮 串关 */
var B4infoTop = (function (_super) {
    __extends(B4infoTop, _super);
    function B4infoTop() {
    ...
    B4infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    B4infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - B4Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    B4infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    B4infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
        ...
        // B4Wnd.getInstance.changeItemHeight();
        B4Wnd.getInstance.updateYH();
        this.changeImg();
    };
    B4infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    B4infoTop.prototype.addInterception = function () {
    ...
    B4infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    B4infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    B4infoTop.prototype.setDB = function () {
...
__reflect(B4infoTop.prototype, "B4infoTop");
var B4info_subInfo = (function (_super) {
    __extends(B4info_subInfo, _super);
    function B4info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
    ...
    B4info_subInfo.prototype.aa = function (data) {
        this._data = data;
        this.id = data.id;
        ...
        this._shapeItem.Gget(16).aa(data.id, data.listSX[16], data.team_a_name, "\u5927\u5206" + data.listSX[16]);
        this._shapeItem.Gget(17).aa(data.id, data.listSX[17], data.team_b_name, "\u5C0F\u5206" + data.listSX[17]);
    };
    B4info_subInfo.prototype.clear = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).clear();
        }
    };
    B4info_subInfo.prototype.changeText = function (num) {
    };
    /**边 117高度 */
    B4info_subInfo.prototype.addedge = function () {
    ...
    /**适配处理 */
    B4info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    B4info_subInfo.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).removeInterception();
        }
    };
    return B4info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(B4info_subInfo.prototype, "B4info_subInfo");
//# sourceMappingURL=B4info.js.map