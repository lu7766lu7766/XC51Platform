...
/**篮球 胜分差 */
var B5Wnd = (function (_super) {
    __extends(B5Wnd, _super);
    function B5Wnd() {
    ...
    Object.defineProperty(B5Wnd, "getInstance", {
        get: function () {
            if (B5Wnd._mInstance == undefined)
                B5Wnd._mInstance = new B5Wnd();
            return B5Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    B5Wnd.prototype.GetItem = function () {
        return this._item;
    };
    B5Wnd.prototype.changeText = function (id, num) {
    ...
    B5Wnd.prototype.updata = function () {
        var _this = this;
        // let item = BasketballDataMrg.getInstance._mLQLBDG;
        var item = BasketballDataMrg.getInstance.getDGList(5);
        var objHeight = 0;
    ...
    /**之刷新数据 */
    B5Wnd.prototype.onlyFreshData = function () {
        var item = BasketballDataMrg.getInstance.getDGList(5);
        var obj;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**滑动时更新数据 */
    B5Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B5Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B5Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B5Wnd.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    B5Wnd.prototype.change = function (event) {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    B5Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    B5Wnd.prototype.setDB = function () {
...
__reflect(B5Wnd.prototype, "B5Wnd");
//# sourceMappingURL=B5Wnd.js.map