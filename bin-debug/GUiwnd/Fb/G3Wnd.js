...
/**进球数 */
var G3Wnd = (function (_super) {
    __extends(G3Wnd, _super);
    function G3Wnd() {
    ...
    Object.defineProperty(G3Wnd, "getInstance", {
        get: function () {
            if (G3Wnd._mInstance == undefined)
                G3Wnd._mInstance = new G3Wnd();
            return G3Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    G3Wnd.prototype.GetItem = function () {
        return this._item;
    };
    G3Wnd.prototype.updata = function () {
        var _this = this;
        // let item = FootballDataMrg.getInstance._mZQLBDG;
        var item = FootballDataMrg.getInstance.getDGList(3);
        var objHeight = 0;
    ...
    /**滑动时更新数据 */
    G3Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
    ...
    G3Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    G3Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**获取滚动位置 */
    G3Wnd.prototype.getViewYYTop = function () {
        return this._scroView.scrollTop;
    };
    G3Wnd.prototype.hide = function () {
    ...
    G3Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    G3Wnd.prototype.setDB = function () {
...
__reflect(G3Wnd.prototype, "G3Wnd");
//# sourceMappingURL=G3Wnd.js.map