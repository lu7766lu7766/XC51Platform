...
/**足 进球数 */
var G3infoTop = (function (_super) {
    __extends(G3infoTop, _super);
    function G3infoTop() {
    ...
    G3infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    G3infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - G3Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    G3infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    G3infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
        ...
        // G3Wnd.getInstance.changeItemHeight();
        G3Wnd.getInstance.updateYH();
    };
    G3infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    G3infoTop.prototype.addInterception = function () {
    ...
    G3infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    G3infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    G3infoTop.prototype.setDB = function () {
...
__reflect(G3infoTop.prototype, "G3infoTop");
var G3info_subInfo = (function (_super) {
    __extends(G3info_subInfo, _super);
    function G3info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
    ...
    G3info_subInfo.prototype.aa = function (data) {
        this._data = data;
        this.id = data.id;
    ...
    G3info_subInfo.prototype.clear = function () {
    ...
    G3info_subInfo.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**边 117高度 */
    G3info_subInfo.prototype.addedge = function () {
    ...
    /**适配处理 */
    G3info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    return G3info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(G3info_subInfo.prototype, "G3info_subInfo");
//# sourceMappingURL=G3info.js.map