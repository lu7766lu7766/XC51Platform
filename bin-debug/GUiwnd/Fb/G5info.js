...
/**足 半全场 */
var G5infoTop = (function (_super) {
    __extends(G5infoTop, _super);
    function G5infoTop() {
    ...
    G5infoTop.prototype.aa = function (data, key) {
        this._data = data;
        // this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    G5infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - G5Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    G5infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    G5infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
    ...
    G5infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    G5infoTop.prototype.addInterception = function () {
    ...
    G5infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    G5infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    G5infoTop.prototype.setDB = function () {
...
__reflect(G5infoTop.prototype, "G5infoTop");
var G5info_subInfo = (function (_super) {
    __extends(G5info_subInfo, _super);
    function G5info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
        ...
        //49
        var obj49 = new Block(49, 110, 128, 41, 70, null, 1);
    ...
    G5info_subInfo.prototype.clear = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**边 117高度 */
    G5info_subInfo.prototype.addedge = function () {
    ...
    /**适配处理 */
    G5info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    return G5info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(G5info_subInfo.prototype, "G5info_subInfo");
//# sourceMappingURL=G5info.js.map