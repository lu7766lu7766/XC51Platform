...
/**胜平负 */
var G2Wnd = (function (_super) {
    __extends(G2Wnd, _super);
    function G2Wnd() {
    ...
    Object.defineProperty(G2Wnd, "getInstance", {
        get: function () {
            if (G2Wnd._mInstance == undefined)
                G2Wnd._mInstance = new G2Wnd();
            return G2Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    G2Wnd.prototype.GetItem = function () {
        return this._item;
    };
    G2Wnd.prototype.updata = function () {
        var _this = this;
        // let item = FootballDataMrg.getInstance._mZQLBDG;
        var item = FootballDataMrg.getInstance.getDGList(2);
        var objHeight = 0;
    ...
    /**滑动时更新数据 */
    G2Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
    ...
    G2Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    G2Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**获取滚动位置 */
    G2Wnd.prototype.getViewYYTop = function () {
        return this._scroView.scrollTop;
    };
    G2Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    G2Wnd.prototype.setDB = function () {
...
__reflect(G2Wnd.prototype, "G2Wnd");
//# sourceMappingURL=G2Wnd.js.map