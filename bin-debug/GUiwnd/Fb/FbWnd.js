...
/**足球头部 底部则重新构写单独控制 */
var FbWnd = (function (_super) {
    __extends(FbWnd, _super);
    function FbWnd() {
    ...
    Object.defineProperty(FbWnd, "getInstance", {
        get: function () {
    ...
    FbWnd.prototype.addTop = function () {
        var _this = this;
    ...
    FbWnd.prototype.touchDown = function (e) {
    ...
    FbWnd.prototype.changeTop = function () {
        if (this._index == 0) {
            ...
            OnePass.getInstance.show();
        }
    };
    /**篮球支付成功回调 关闭支付界面 单开订单*/
    FbWnd.prototype.zfBack = function () {
    ...
    FbWnd.prototype.addInterception = function () {
    ...
    FbWnd.prototype.removeInterception = function () {
    ...
    FbWnd.prototype.clickBtn = function (e) {
        if (e.target == this._screen) {
            FBscreen.getInstance.show();
        }
        else if (e.target == this._return) {
            this.hide();
        }
        else if (e.target == this._questions) {
            FbExplain.getInstance.show();
        }
    };
...
__reflect(FbWnd.prototype, "FbWnd");
//# sourceMappingURL=FbWnd.js.map