...
/**比分 */
var G4Wnd = (function (_super) {
    __extends(G4Wnd, _super);
    function G4Wnd() {
    ...
    Object.defineProperty(G4Wnd, "getInstance", {
        get: function () {
    ...
    G4Wnd.prototype.GetItem = function () {
        return this._item;
    };
    G4Wnd.prototype.updata = function () {
        var _this = this;
        // let item = FootballDataMrg.getInstance._mZQLBDG;
        var item = FootballDataMrg.getInstance.getDGList(4);
        var objHeight = 0;
    ...
    /**滑动时更新数据 */
    G4Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
    ...
    G4Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    G4Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    G4Wnd.prototype.change = function (event) {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._item.Gget(key).optimization();
        }
    };
    G4Wnd.prototype.hide = function () {
    ...
    G4Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    G4Wnd.prototype.setDB = function () {
...
__reflect(G4Wnd.prototype, "G4Wnd");
//# sourceMappingURL=G4Wnd.js.map