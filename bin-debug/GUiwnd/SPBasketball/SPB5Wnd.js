...
/**篮球 胜分差 */
var SPB5Wnd = (function (_super) {
    __extends(SPB5Wnd, _super);
    function SPB5Wnd() {
    ...
    Object.defineProperty(SPB5Wnd, "getInstance", {
        get: function () {
            if (SPB5Wnd._mInstance == undefined)
                SPB5Wnd._mInstance = new SPB5Wnd();
            return SPB5Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    SPB5Wnd.prototype.GetItem = function () {
        return this._item;
    };
    SPB5Wnd.prototype.changeText = function (id, num) {
    ...
    SPB5Wnd.prototype.updata = function () {
        var _this = this;
        // let item = BasketballDataMrg.getInstance._mLQLBDG;
        var item = BasketballDataMrg.getInstance.getCJDGList(5);
        var objHeight = 0;
    ...
    /**之刷新数据 */
    SPB5Wnd.prototype.onlyFreshData = function () {
        var item = BasketballDataMrg.getInstance.getCJDGList(5);
        var obj;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**滑动时更新数据 */
    SPB5Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPB5Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPB5Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPB5Wnd.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    SPB5Wnd.prototype.change = function (event) {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPB5Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    SPB5Wnd.prototype.setDB = function () {
...
__reflect(SPB5Wnd.prototype, "SPB5Wnd");
//# sourceMappingURL=SPB5Wnd.js.map