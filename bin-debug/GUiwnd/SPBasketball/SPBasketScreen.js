...
/**篮球筛选 */
var SPBasketScreen = (function (_super) {
    __extends(SPBasketScreen, _super);
    function SPBasketScreen() {
    ...
    Object.defineProperty(SPBasketScreen, "getInstance", {
        get: function () {
            if (SPBasketScreen._mInstance == undefined)
                SPBasketScreen._mInstance = new SPBasketScreen();
            return SPBasketScreen._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    SPBasketScreen.prototype.updata = function () {
        var item = new GHashMap();
        var data;
        if (SPBasketBallWnd.inIndex == 0) {
            data = BasketballDataMrg.getInstance._mCJLQLB;
        }
        else {
            data = BasketballDataMrg.getInstance.getCJDGList(SPBasketBallWnd.inIndex + 1);
            // data = BasketballDataMrg.getInstance._mCJLQLBDG;
        }
    ...
    SPBasketScreen.prototype.show = function () {
        GUIManager.getInstance.mostLay.addChild(this);
        this.addInterception();
        this.updata();
    };
    SPBasketScreen.prototype.hide = function () {
    ...
    SPBasketScreen.prototype.addOfremoveToSelectItem = function (data, isboom) {
        if (isboom) {
    ...
    SPBasketScreen.prototype.selectBtnofItem = function (e) {
    ...
    SPBasketScreen.prototype.touchDown = function (e) {
        if (e.target == this._defineBtn) {
            ...
            if (SPBasketBallWnd.inIndex == 0) {
                SPB1Wnd.getInstance.screenSelect(data);
            }
            else if (SPBasketBallWnd.inIndex == 1) {
                SPB2Wnd.getInstance.screenSelect(data);
            }
            else if (SPBasketBallWnd.inIndex == 2) {
                SPB3Wnd.getInstance.screenSelect(data);
            }
            else if (SPBasketBallWnd.inIndex == 3) {
                SPB4Wnd.getInstance.screenSelect(data);
            }
            else if (SPBasketBallWnd.inIndex == 4) {
                SPB5Wnd.getInstance.screenSelect(data);
            }
        }
        this.hide();
    };
    SPBasketScreen.prototype.addInterception = function () {
    ...
    SPBasketScreen.prototype.removeInterception = function () {
    ...
    /**适配处理 */
    SPBasketScreen.prototype.setDB = function () {
    ...
    SPBasketScreen.prototype.joinTop = function () {
    ...
    SPBasketScreen.prototype.addScoll = function () {
    ...
    SPBasketScreen.prototype.joinDown = function () {
        var _this = this;
    ...
    return SPBasketScreen;
}(egret.DisplayObjectContainer));
__reflect(SPBasketScreen.prototype, "SPBasketScreen");
//# sourceMappingURL=SPBasketScreen.js.map