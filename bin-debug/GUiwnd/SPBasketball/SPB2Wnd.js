...
/**篮球 让分胜负 */
var SPB2Wnd = (function (_super) {
    __extends(SPB2Wnd, _super);
    function SPB2Wnd() {
    ...
    Object.defineProperty(SPB2Wnd, "getInstance", {
        get: function () {
            if (SPB2Wnd._mInstance == undefined)
                SPB2Wnd._mInstance = new SPB2Wnd();
            return SPB2Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    SPB2Wnd.prototype.GetItem = function () {
        return this._item;
    };
    SPB2Wnd.prototype.changeText = function (id, num) {
    ...
    SPB2Wnd.prototype.updata = function () {
        var _this = this;
        // let item = BasketballDataMrg.getInstance._mLQLBDG;
        var item = BasketballDataMrg.getInstance.getCJDGList(2);
        var objHeight = 0;
    ...
    /**之刷新数据 */
    SPB2Wnd.prototype.onlyFreshData = function () {
        var item = BasketballDataMrg.getInstance.getCJDGList(2);
        var obj;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**滑动时更新数据 */
    SPB2Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPB2Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPB2Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPB2Wnd.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    /**获取滚动位置 */
    SPB2Wnd.prototype.getViewYYTop = function () {
        return this._scroView.scrollTop;
    };
    SPB2Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    SPB2Wnd.prototype.setDB = function () {
...
__reflect(SPB2Wnd.prototype, "SPB2Wnd");
//# sourceMappingURL=SPB2Wnd.js.map