...
/**篮 串关 */
var SPB5infoTop = (function (_super) {
    __extends(SPB5infoTop, _super);
    function SPB5infoTop() {
    ...
    SPB5infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    SPB5infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - SPB5Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    SPB5infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    SPB5infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
    ...
    SPB5infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    SPB5infoTop.prototype.addInterception = function () {
    ...
    SPB5infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    SPB5infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    SPB5infoTop.prototype.setDB = function () {
...
__reflect(SPB5infoTop.prototype, "SPB5infoTop");
var SPB5info_subInfo = (function (_super) {
    __extends(SPB5info_subInfo, _super);
    function SPB5info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
    ...
    SPB5info_subInfo.prototype.aa = function (data) {
        this._data = data;
        this.id = data.id;
    ...
    SPB5info_subInfo.prototype.clear = function () {
    ...
    SPB5info_subInfo.prototype.changeText = function (num) {
        this._boxShape.graphics.clear();
        if (num.length > 0) {
    ...
    SPB5info_subInfo.prototype.touchDown = function (e) {
        if (e.target == this._tipText) {
            SPB5more.getInstance.show(this._data.id);
        }
    };
    /**边 117高度 */
    SPB5info_subInfo.prototype.addedge = function () {
    ...
    /**适配处理 */
    SPB5info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    SPB5info_subInfo.prototype.removeInterception = function () {
        this._tipText.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
    };
    return SPB5info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(SPB5info_subInfo.prototype, "SPB5info_subInfo");
//# sourceMappingURL=SPB5info.js.map