...
/**篮 串关 */
var SPB2infoTop = (function (_super) {
    __extends(SPB2infoTop, _super);
    function SPB2infoTop() {
    ...
    SPB2infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    SPB2infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - SPB2Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    SPB2infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    SPB2infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
        ...
        // SPB2Wnd.getInstance.changeItemHeight();
        this.changeImg();
        B1Wnd.getInstance.updateYH();
    };
    SPB2infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    SPB2infoTop.prototype.addInterception = function () {
    ...
    SPB2infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    SPB2infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    SPB2infoTop.prototype.setDB = function () {
...
__reflect(SPB2infoTop.prototype, "SPB2infoTop");
var SPB2info_subInfo = (function (_super) {
    __extends(SPB2info_subInfo, _super);
    function SPB2info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
        ...
        var zhu = ToolMrg.getText(394, 77, 24, 0xf72e52);
        _this.addChild(zhu);
        zhu.text = "主";
    ...
    SPB2info_subInfo.prototype.aa = function (data) {
        this._data = data;
        this.id = data.id;
    ...
    SPB2info_subInfo.prototype.clear = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).clear();
        }
    };
    SPB2info_subInfo.prototype.changeText = function (num) {
    };
    /**边 117高度 */
    SPB2info_subInfo.prototype.addedge = function () {
    ...
    /**适配处理 */
    SPB2info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    SPB2info_subInfo.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).removeInterception();
        }
    };
    return SPB2info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(SPB2info_subInfo.prototype, "SPB2info_subInfo");
//# sourceMappingURL=SPB2info.js.map