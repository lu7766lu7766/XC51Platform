...
/**篮 串关 */
var SPB3infoTop = (function (_super) {
    __extends(SPB3infoTop, _super);
    function SPB3infoTop() {
    ...
    SPB3infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    SPB3infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - SPB3Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    SPB3infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    SPB3infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
        ...
        // SPB3Wnd.getInstance.changeItemHeight();
        this.changeImg();
        SPB3Wnd.getInstance.updateYH();
    };
    SPB3infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    SPB3infoTop.prototype.addInterception = function () {
    ...
    SPB3infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    SPB3infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    SPB3infoTop.prototype.setDB = function () {
...
__reflect(SPB3infoTop.prototype, "SPB3infoTop");
var SPB3info_subInfo = (function (_super) {
    __extends(SPB3info_subInfo, _super);
    function SPB3info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
    ...
    SPB3info_subInfo.prototype.aa = function (data) {
        this._data = data;
        this.id = data.id;
    ...
    SPB3info_subInfo.prototype.clear = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).clear();
        }
    };
    SPB3info_subInfo.prototype.changeText = function (num) {
    };
    /**边 117高度 */
    SPB3info_subInfo.prototype.addedge = function () {
    ...
    /**适配处理 */
    SPB3info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    SPB3info_subInfo.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).removeInterception();
        }
    };
    return SPB3info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(SPB3info_subInfo.prototype, "SPB3info_subInfo");
//# sourceMappingURL=SPB3info.js.map