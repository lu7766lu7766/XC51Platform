...
var ID2 = (function (_super) {
    ...
    function ID2() {
        ...
        RES.getResByUrl("resource/assets/images/ui/zhuli1.png", function (e) { btn1.$setBitmapData(e); }, _this);
        var btn2 = new egret.Bitmap();
        _this._mContain.addChild(btn2);
        btn2.y = 744;
        RES.getResByUrl("resource/assets/images/ui/zhuli2.png", function (e) { btn2.$setBitmapData(e); }, _this);
        var btn3 = new egret.Bitmap();
        _this._mContain.addChild(btn3);
        btn3.y = 744 + 626;
        RES.getResByUrl("resource/assets/images/ui/zhuli3.png", function (e) { btn3.$setBitmapData(e); }, _this);
