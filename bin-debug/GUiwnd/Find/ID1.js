...
var ID1 = (function (_super) {
    ...
    function ID1() {
        ...
        RES.getResByUrl("resource/assets/images/ui/jqs1_find@2x.png", function (e) { btn1.$setBitmapData(e); }, _this);
        var btn2 = new egret.Bitmap();
        _this._mContain.addChild(btn2);
        btn2.y = 585;
        RES.getResByUrl("resource/assets/images/ui/jqs2_find@2x.png", function (e) { btn2.$setBitmapData(e); }, _this);
