...
/**比分 */
var SPG4Wnd = (function (_super) {
    __extends(SPG4Wnd, _super);
    function SPG4Wnd() {
    ...
    Object.defineProperty(SPG4Wnd, "getInstance", {
        get: function () {
            if (SPG4Wnd._mInstance == undefined)
                SPG4Wnd._mInstance = new SPG4Wnd();
            return SPG4Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    SPG4Wnd.prototype.GetItem = function () {
        return this._item;
    };
    SPG4Wnd.prototype.updata = function () {
        var _this = this;
        // let item = FootballDataMrg.getInstance._mZQLBDG;
        var item = FootballDataMrg.getInstance.getCJDGList(4);
        var objHeight = 0;
    ...
    /**滑动时更新数据 */
    SPG4Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
    ...
    SPG4Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG4Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG4Wnd.prototype.change = function (event) {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._item.Gget(key).optimization();
        }
    };
    SPG4Wnd.prototype.hide = function () {
    ...
    SPG4Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    SPG4Wnd.prototype.setDB = function () {
...
__reflect(SPG4Wnd.prototype, "SPG4Wnd");
//# sourceMappingURL=SPG4Wnd.js.map