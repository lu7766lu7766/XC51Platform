...
/**胜平负 */
var SPG2Wnd = (function (_super) {
    __extends(SPG2Wnd, _super);
    function SPG2Wnd() {
    ...
    Object.defineProperty(SPG2Wnd, "getInstance", {
        get: function () {
    ...
    SPG2Wnd.prototype.GetItem = function () {
        return this._item;
    };
    SPG2Wnd.prototype.updata = function () {
        var _this = this;
        // let item = FootballDataMrg.getInstance._mZQLBDG;
        var item = FootballDataMrg.getInstance.getCJDGList(2);
        var objHeight = 0;
    ...
    /**滑动时更新数据 */
    SPG2Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
    ...
    SPG2Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG2Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG2Wnd.prototype.hide = function () {
    ...
    /**获取滚动位置 */
    SPG2Wnd.prototype.getViewYYTop = function () {
        return this._scroView.scrollTop;
    };
    SPG2Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    SPG2Wnd.prototype.setDB = function () {
...
__reflect(SPG2Wnd.prototype, "SPG2Wnd");
//# sourceMappingURL=SPG2Wnd.js.map