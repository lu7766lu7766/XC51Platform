...
/**足 胜平负 */
var SPG2infoTop = (function (_super) {
    __extends(SPG2infoTop, _super);
    function SPG2infoTop() {
    ...
    SPG2infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    SPG2infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - SPG2Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    SPG2infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    SPG2infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
    ...
    SPG2infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    SPG2infoTop.prototype.addInterception = function () {
    ...
    SPG2infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    SPG2infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    SPG2infoTop.prototype.setDB = function () {
...
__reflect(SPG2infoTop.prototype, "SPG2infoTop");
var SPG2info_subInfo = (function (_super) {
    __extends(SPG2info_subInfo, _super);
    function SPG2info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
    ...
    SPG2info_subInfo.prototype.aa = function (data) {
        this._data = data;
        this.id = data.id;
    ...
    SPG2info_subInfo.prototype.removeInterception = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).removeInterception();
        }
    };
    SPG2info_subInfo.prototype.clear = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**边 117高度 */
    SPG2info_subInfo.prototype.addedge = function () {
        var _this = this;
    ...
    /**适配处理 */
    SPG2info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    return SPG2info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(SPG2info_subInfo.prototype, "SPG2info_subInfo");
//# sourceMappingURL=SPG2info.js.map