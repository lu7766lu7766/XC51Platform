...
/**更多玩法 比分 */
var SPG4more = (function (_super) {
    __extends(SPG4more, _super);
    function SPG4more() {
    ...
    Object.defineProperty(SPG4more, "getInstance", {
        get: function () {
            if (SPG4more._mInstance == undefined)
                SPG4more._mInstance = new SPG4more();
            return SPG4more._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    SPG4more.prototype.show = function (obj, data) {
    ...
    //进入时显示选中
    SPG4more.prototype.startDataOfCss = function () {
    ...
    /**如果返回id与点进id不匹配则不刷新 */
    SPG4more.prototype.upThisValue = function (id, data) {
        if (id != this._id) {
    ...
    SPG4more.prototype.hide = function () {
    ...
    //hide时清理数值
    SPG4more.prototype.clearDataOfCss = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    /**适配处理 */
    SPG4more.prototype.setDB = function () {
    ...
    SPG4more.prototype.joinSPBlock = function () {
        //6-17
        var bjTop = 0;
        for (var i = 6; i < 18; i++) {
            var obj = new SPBlock(i, 120, 62, null, null, 1);
        ...
        //18
        var obj18 = new SPBlock(18, 368, 62, null, null, 1);
        obj18.x = 326;
        obj18.y = 250;
        ...
        //36
        var obj36 = new SPBlock(36, 368, 62, null, null, 1);
        obj36.x = 326;
        obj36.y = 514;
    ...
    SPG4more.prototype.touchDown = function (e) {
        if (e.target == this._defineBtn) {
            SPOnePass.getInstance.upChangeSubMore(this._id, this._numItem);
        }
        this.hide();
    };
    SPG4more.prototype.changeNumItem = function (index, isboom) {
        if (isboom) {
    ...
    SPG4more.prototype.addInterception = function () {
    ...
    SPG4more.prototype.removeInterception = function () {
...
__reflect(SPG4more.prototype, "SPG4more");
//# sourceMappingURL=SPG4more.js.map