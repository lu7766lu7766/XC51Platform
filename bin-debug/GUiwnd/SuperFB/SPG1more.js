...
/**更多玩法 串关 */
var SPG1more = (function (_super) {
    __extends(SPG1more, _super);
    function SPG1more() {
    ...
    Object.defineProperty(SPG1more, "getInstance", {
        get: function () {
            if (SPG1more._mInstance == undefined)
                SPG1more._mInstance = new SPG1more();
            return SPG1more._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    /**如果返回id与点进id不匹配则不刷新 */
    SPG1more.prototype.upThisValue = function (id, data) {
        if (id != this._id) {
    ...
    SPG1more.prototype.touchDown = function (e) {
        if (e.target == this._Define) {
            SPG1Wnd.getInstance.upChangeSubMore(this._id, this._numItem);
        }
        this.hide();
    };
    //进入时显示选中
    SPG1more.prototype.startDataOfCss = function () {
    ...
    SPG1more.prototype.show = function (obj, data) {
    ...
    SPG1more.prototype.updateData = function () {
        if (this._obj != undefined)
            this.upThisValue(this._obj.id, this._obj.listSX);
    };
    SPG1more.prototype.hide = function () {
    ...
    //hide时清理数值
    SPG1more.prototype.clearDataOfCss = function () {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            var obj = this._item.Gget(key);
    ...
    SPG1more.prototype.addScoll = function () {
    ...
    /**适配处理 */
    SPG1more.prototype.setDB = function () {
    ...
    SPG1more.prototype.joinCenter = function () {
    ...
    SPG1more.prototype.joinDown = function () {
        var _this = this;
    ...
    /**加入块样式 */
    SPG1more.prototype.joinSPBlock = function () {
        //0-5
        for (var i = 0; i < 6; i++) {
            var obj = new SPBlock(i, 202, 56, null, null, 0);
        ...
        var bjTop = 0;
        for (var i = 6; i < 18; i++) {
            var obj = new SPBlock(i, 120, 62, null, null, 0);
            this._mContain.addChild(obj);
            this._item.Gput(obj.index, obj);
            if (bjTop < 5) {
                obj.y = 200;
        ...
        //18
        var obj18 = new SPBlock(18, 368, 62, null, null, 0);
        obj18.x = 340;
        obj18.y = 332;
        ...
        //36
        var obj36 = new SPBlock(36, 369, 62, null, null, 0);
        obj36.x = 340;
        obj36.y = 596;
        ...
        //总进球开始 37-44
        for (var i = 37; i < 45; i++) {
            var obj = new SPBlock(i, 152, 62, null, null, 0);
            this._mContain.addChild(obj);
            this._item.Gput(obj.index, obj);
            if (i < 41) {
                obj.x = 92 + 156 * (i - 37);
        ...
        //49
        var obj49 = new SPBlock(49, 120, 128, 40, 70, 0);
    ...
    SPG1more.prototype.changeTextOf6_53 = function () {
        for (var i = 6; i < 54; i++) {
            this._item.Gget(i).aa(null, null, null, FootballDataMrg.getInstance.fbNameItem[i]);
        }
    };
    SPG1more.prototype.changeNumItem = function (index, isboom) {
        if (isboom) {
    ...
    SPG1more.prototype.addInterception = function () {
    ...
    SPG1more.prototype.removeInterception = function () {
        this._mShareC.addEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
...
__reflect(SPG1more.prototype, "SPG1more");
//# sourceMappingURL=SPG1more.js.map