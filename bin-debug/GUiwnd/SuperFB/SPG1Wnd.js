...
/**过关 */
var SPG1Wnd = (function (_super) {
    __extends(SPG1Wnd, _super);
    function SPG1Wnd() {
    ...
    Object.defineProperty(SPG1Wnd, "getInstance", {
        get: function () {
    ...
    //测试数据
    SPG1Wnd.prototype.test = function () {
        var id = 0;
        for (var i = 0; i < 3; i++) {
            var fb = new GHashMap();
            for (var k = 0; k < 3; k++) {
    ...
    /**获取当前所选数组长度 */
    SPG1Wnd.prototype.getArrSize = function () {
        return this._arr;
    };
    SPG1Wnd.prototype.ClickRemove = function (id) {
        if (id != undefined) {
    ...
    SPG1Wnd.prototype.updata = function () {
        var _this = this;
        var item = FootballDataMrg.getInstance._mCJZQLB;
        var objHeight = 0;
        var obj;
    ...
    /**滑动时更新数据 */
    SPG1Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**之刷新数据 */
    SPG1Wnd.prototype.onlyFreshData = function () {
        var item = FootballDataMrg.getInstance._mCJZQLB;
        var obj;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG1Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG1Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**获取滚动位置 */
    SPG1Wnd.prototype.getViewYYTop = function () {
        return this._scroView.scrollTop;
    };
    /**清除G1所有数据 */
    SPG1Wnd.prototype.clearAllData = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**清除G1所有数据 */
    SPG1Wnd.prototype.clearSPAllData = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
    ...
    /**id:赛事id */
    SPG1Wnd.prototype.upChangeSubMore = function (id, data) {
    ...
    /**传入当前id 以及足球表对象 */
    SPG1Wnd.prototype.changeTextAndData = function (id, index, isboom) {
        if (isboom) {
            var obj = void 0;
            if (this.allItem.GhasKey(id)) {
    ...
    /**map转换arr */
    SPG1Wnd.prototype.setitemToArr = function () {
        var arr = [];
    ...
    SPG1Wnd.prototype.GoChange = function (e) {
    ...
    SPG1Wnd.prototype.joinDown = function () {
        var _this = this;
    ...
    SPG1Wnd.prototype.httpUpdata = function (e) {
        if (e.data != undefined) {
            if (e.data.cf == 1) {
                // this.clearAllData();
                this.updata();
    ...
    SPG1Wnd.prototype.show = function () {
    ...
    SPG1Wnd.prototype.change = function (event) {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._item.Gget(key).optimization();
        }
    };
    SPG1Wnd.prototype.hide = function () {
    ...
    SPG1Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    SPG1Wnd.prototype.setDB = function () {
...
__reflect(SPG1Wnd.prototype, "SPG1Wnd");
//# sourceMappingURL=SPG1Wnd.js.map