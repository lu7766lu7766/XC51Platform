...
/**半全场 */
var SPG5Wnd = (function (_super) {
    __extends(SPG5Wnd, _super);
    function SPG5Wnd() {
    ...
    Object.defineProperty(SPG5Wnd, "getInstance", {
        get: function () {
            if (SPG5Wnd._mInstance == undefined)
                SPG5Wnd._mInstance = new SPG5Wnd();
            return SPG5Wnd._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    SPG5Wnd.prototype.GetItem = function () {
        return this._item;
    };
    SPG5Wnd.prototype.updata = function () {
        var _this = this;
        // let item = FootballDataMrg.getInstance._mZQLBDG;
        var item = FootballDataMrg.getInstance.getCJDGList(5);
        var objHeight = 0;
    ...
    /**滑动时更新数据 */
    SPG5Wnd.prototype.updateYH = function () {
        var objHeight = 0;
        var obj;
    ...
    SPG5Wnd.prototype.screenSelect = function (data) {
        var item = data;
        var objHeight = 0;
        for (var _i = 0, _a = item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG5Wnd.prototype.changeItemHeight = function () {
        var objHeight = 0;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG5Wnd.prototype.change = function (event) {
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._item.Gget(key).optimization();
        }
    };
    SPG5Wnd.prototype.hide = function () {
    ...
    SPG5Wnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    SPG5Wnd.prototype.setDB = function () {
...
__reflect(SPG5Wnd.prototype, "SPG5Wnd");
//# sourceMappingURL=SPG5Wnd.js.map