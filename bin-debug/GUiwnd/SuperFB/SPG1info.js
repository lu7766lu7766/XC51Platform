...
/**足 串关 */
var SPG1infoTop = (function (_super) {
    __extends(SPG1infoTop, _super);
    function SPG1infoTop() {
    ...
    SPG1infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**之刷新数据 */
    SPG1infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    /**列表优化 == 滑动列表*/
    SPG1infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - SPG1Wnd.getInstance.getViewYYTop();
    ...
    //收起 展开显示
    SPG1infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
    ...
    SPG1infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    SPG1infoTop.prototype.addInterception = function () {
    ...
    SPG1infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    SPG1infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    SPG1infoTop.prototype.setDB = function () {
...
__reflect(SPG1infoTop.prototype, "SPG1infoTop");
var SPG1info_subInfo = (function (_super) {
    __extends(SPG1info_subInfo, _super);
    function SPG1info_subInfo() {
        var _this = _super.call(this) || this;
        _this.addedge();
    ...
    SPG1info_subInfo.prototype.removeInterception = function () {
    ...
    SPG1info_subInfo.prototype.touchDown = function (e) {
        // if(e.target == this._moreShape){
        //      SPG1more.getInstance.show(this._data,this.strMap);
        // }
    };
    SPG1info_subInfo.prototype.aa = function (data) {
        this._data = data;
        this.id = data.id;
    ...
    /**改变样式 */
    SPG1info_subInfo.prototype.changeText = function (arr) {
        this.strMap.clear();
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    SPG1info_subInfo.prototype.clear = function () {
        for (var _i = 0, _a = this._shapeItem.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            this._shapeItem.Gget(key).clear();
        }
    ...
    /**边 117高度 */
    SPG1info_subInfo.prototype.addedge = function () {
        var _this = this;
    ...
    /**适配处理 */
    SPG1info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    return SPG1info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(SPG1info_subInfo.prototype, "SPG1info_subInfo");
//# sourceMappingURL=SPG1info.js.map