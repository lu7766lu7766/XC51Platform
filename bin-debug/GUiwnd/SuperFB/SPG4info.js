...
/**足 比分 */
var SPG4infoTop = (function (_super) {
    __extends(SPG4infoTop, _super);
    function SPG4infoTop() {
    ...
    SPG4infoTop.prototype.aa = function (data, key) {
        this._data = data;
        this._type = false;
    ...
    /**列表优化 == 滑动列表*/
    SPG4infoTop.prototype.optimization = function () {
        var data;
        for (var _i = 0, _a = this._item.keys; _i < _a.length; _i++) {
            var key = _a[_i];
            data = this._item.Gget(key);
            if (this._type == false) {
                var yy = (this.y + data.y) - SPG4Wnd.getInstance.getViewYYTop();
    ...
    /**之刷新数据 */
    SPG4infoTop.prototype.freshData = function (data) {
        var obj;
        for (var _i = 0, _a = data.keys; _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    //收起 展开显示
    SPG4infoTop.prototype.changeUpDown = function () {
        if (this._type) {
            this._type = false;
        ...
        // SPG4Wnd.getInstance.changeItemHeight();
        this.changeImg();
        SPG4Wnd.getInstance.updateYH();
    };
    SPG4infoTop.prototype.changeImg = function () {
        var _this = this;
        if (this._type)
    ...
    SPG4infoTop.prototype.addInterception = function () {
    ...
    SPG4infoTop.prototype.removeInterception = function () {
        this._type = false;
        if (this._isInterception) {
    ...
    SPG4infoTop.prototype.getSubItem = function () {
        return this._item;
    };
    /**适配处理 */
    SPG4infoTop.prototype.setDB = function () {
...
__reflect(SPG4infoTop.prototype, "SPG4infoTop");
var SPG4info_subInfo = (function (_super) {
    __extends(SPG4info_subInfo, _super);
    function SPG4info_subInfo() {
        var _this = _super.call(this) || this;
        _this._isInterception = false;
        _this.addedge();
    ...
    SPG4info_subInfo.prototype.aa = function (data, isFresh) {
        this._data = data;
        this.id = data.id;
    ...
    SPG4info_subInfo.prototype.clear = function () {
        this.changeText([]);
    };
    SPG4info_subInfo.prototype.changeText = function (arr) {
        var _this = this;
        this.strMap.clear();
        if (arr.length > 0) {
    ...
    /**边 117高度 */
    SPG4info_subInfo.prototype.addedge = function () {
        var _this = this;
    ...
    SPG4info_subInfo.prototype.addInterception = function () {
        if (!this._isInterception) {
            this._boxShape.addEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
            this._isInterception = true;
        }
    };
    SPG4info_subInfo.prototype.removeInterception = function () {
        if (this._isInterception) {
            this._boxShape.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
            this._isInterception = false;
        }
    };
    SPG4info_subInfo.prototype.touchDown = function (e) {
        SPG4more.getInstance.show(this._data, this.strMap);
    };
    /**适配处理 */
    SPG4info_subInfo.prototype.setDB = function () {
        var _this = this;
    ...
    return SPG4info_subInfo;
}(egret.DisplayObjectContainer));
__reflect(SPG4info_subInfo.prototype, "SPG4info_subInfo");
//# sourceMappingURL=SPG4info.js.map