...
/**超级足球筛选 */
var SPFBscreen = (function (_super) {
    __extends(SPFBscreen, _super);
    function SPFBscreen() {
    ...
    Object.defineProperty(SPFBscreen, "getInstance", {
        get: function () {
    ...
    SPFBscreen.prototype.updata = function () {
    ...
    SPFBscreen.prototype.show = function () {
        GUIManager.getInstance.mostLay.addChild(this);
        this.addInterception();
        this.updata();
    };
    SPFBscreen.prototype.hide = function () {
    ...
    SPFBscreen.prototype.addOfremoveToSelectItem = function (data, isboom) {
        if (isboom) {
    ...
    SPFBscreen.prototype.selectBtnofItem = function (e) {
    ...
    SPFBscreen.prototype.touchDown = function (e) {
    ...
    SPFBscreen.prototype.addInterception = function () {
    ...
    SPFBscreen.prototype.removeInterception = function () {
    ...
    /**适配处理 */
    SPFBscreen.prototype.setDB = function () {
    ...
    SPFBscreen.prototype.addScoll = function () {
    ...
    SPFBscreen.prototype.joinTop = function () {
    ...
    SPFBscreen.prototype.joinDown = function () {
        var _this = this;
...
__reflect(SPFBscreen.prototype, "SPFBscreen");
//# sourceMappingURL=SPFBscreen.js.map