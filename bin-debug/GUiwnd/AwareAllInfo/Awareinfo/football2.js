...
/**足球赛果数据显示*/
var football2 = (function (_super) {
    __extends(football2, _super);
    function football2() {
    ...
    Object.defineProperty(football2, "getInstance", {
        get: function () {
            if (football2._mInstance == undefined)
                football2._mInstance = new football2();
            return football2._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    football2.prototype.addScoll = function (contain, scroView) {
        scroView.x = 0;
        scroView.y = 50;
    ...
    football2.prototype.show = function () {
    ...
    football2.prototype.hide = function () {
        if (this == undefined)
            return;
        if (this.parent != undefined) {
    ...
    football2.prototype.bgBack1 = function (data, url) {
        if (data != undefined && this._heicon != undefined) {
            this._heicon.$setBitmapData(data);
        }
    };
    /**初始化所有数据*/
    football2.prototype.initallInfo = function () {
        var len = 3;
        var dataObj;
        for (var i = 1; i <= len; i++) {
    ...
    //清除对象数组
    football2.prototype.hideData = function () {
...
__reflect(football2.prototype, "football2");
//# sourceMappingURL=football2.js.map