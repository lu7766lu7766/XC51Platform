...
/**关于 */
var AboutWnd = (function (_super) {
    __extends(AboutWnd, _super);
    function AboutWnd() {
        var _this = _super.call(this) || this;
        _this.touchEnabled = true;
        _this._topUI = new TopUI("关于51彩站");
    ...
    Object.defineProperty(AboutWnd, "getInstance", {
        get: function () {
    ...
    AboutWnd.prototype.joinContain = function () {
        var img = new egret.Bitmap();
        this._mContain.addChild(img);
        img.y = 55;
        RES.getResByUrl("resource/assets/images/ui/51_mine@2x.png", function (e) {
            img.$setBitmapData(e);
    ...
    AboutWnd.prototype.show = function () {
        GUIManager.getInstance.topLay.addChild(this);
        this.addInterception();
    };
    AboutWnd.prototype.hide = function () {
        if (this.parent != undefined) {
            this.parent.removeChild(this);
            this.removeInterception();
        }
    };
    AboutWnd.prototype.touchDown = function (e) {
        if (e.target == this._return) {
            this.hide();
        }
    };
    AboutWnd.prototype.addInterception = function () {
        this._return.addEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
    };
    AboutWnd.prototype.removeInterception = function () {
        this._return.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
    };
    AboutWnd.prototype.addScoll = function () {
    ...
    /**适配处理 */
    AboutWnd.prototype.setDB = function () {
...
__reflect(AboutWnd.prototype, "AboutWnd");
//# sourceMappingURL=AboutWnd.js.map