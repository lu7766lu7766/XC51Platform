...
var BK_One = (function () {
    function BK_One() {
        ...
        GTimerMag.getInstance.addTimerTask("BK_One", 9999999, GameValue.httpSendTime, function () {
            _this._mIsSend[_this._mtype] = 0;
            _this.sendHttp(_this._mtype, _this._mParent[_this._mtype], true);
        }, this);
    }
    Object.defineProperty(BK_One, "getInstance", {
        get: function () {
     ...
     */
    BK_One.prototype.sendHttp = function (type, obj, bool) {
        this._mtype = type;
...
__reflect(BK_One.prototype, "BK_One", ["IProHandle"]);
//# sourceMappingURL=BK_One.js.map