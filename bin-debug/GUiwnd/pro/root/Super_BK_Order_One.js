 ...
 */
var Super_BK_Order_One = (function () {
    function Super_BK_Order_One() {
        this.data = new HttpData();
        this.data.mKey = "Super_BK_Order_One";
    }
    Object.defineProperty(Super_BK_Order_One, "getInstance", {
        get: function () {
     ...
     * mold:金额类型(多个用逗号隔开,1=>充值金额 2=>中奖金额  3=>优惠金额）
     */
    Super_BK_Order_One.prototype.sendHttp = function (dataItem, dryingData, t, select, b, m, czType) {
        var url = HTTPRequest.getInstance.httpHeadUrl + "/super_BK_Order_One.php";
        var strChuan = "";
    ...
    Super_BK_Order_One.prototype.backHTTP = function (res, httpObj, data) {
    ...
    return Super_BK_Order_One;
}());
__reflect(Super_BK_Order_One.prototype, "Super_BK_Order_One", ["IProHandle"]);
//# sourceMappingURL=Super_BK_Order_One.js.map