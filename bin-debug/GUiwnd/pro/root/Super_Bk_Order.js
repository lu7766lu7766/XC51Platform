 ...
 */
var Super_Bk_Order = (function () {
    function Super_Bk_Order() {
        this.data = new HttpData();
        this.data.mKey = "Super_Bk_Order";
    }
    Object.defineProperty(Super_Bk_Order, "getInstance", {
        get: function () {
            if (Super_Bk_Order._mInstance == undefined)
                Super_Bk_Order._mInstance = new Super_Bk_Order();
            return Super_Bk_Order._mInstance;
        },
        enumerable: true,
        configurable: true
    });
     ...
     */
    Super_Bk_Order.prototype.sendHttp = function (list, dryingData, t, select, czType) {
        var url = HTTPRequest.getInstance.httpHeadUrl + "/super_Bk_Order.php";
        var a = new Array();
        var zs = 0;
        var m = 0;
        var obj;
    ...
    Super_Bk_Order.prototype.backHTTP = function (res, httpObj, data) {
    ...
    return Super_Bk_Order;
}());
__reflect(Super_Bk_Order.prototype, "Super_Bk_Order", ["IProHandle"]);
//# sourceMappingURL=Super_Bk_Order.js.map