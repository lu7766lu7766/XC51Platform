...
var DmC_info = (function (_super) {
    ...
    function DmC_info() {
        ...
        _this._multiple = new egret.TextField();
        _this.addChild(_this._multiple);
        _this._multiple.x = 548;
        _this._multiple.y = 22;
        _this._multiple.width = 158;
        _this._multiple.textAlign = egret.HorizontalAlign.RIGHT;
        _this._multiple.textColor = 0xf72e52;
        _this._multiple.size = 48;
        _this._lll = ToolMrg.getText(706, 48, 18, 0xf72e52);
