...
var SPFbExplain = (function (_super) {
    __extends(SPFbExplain, _super);
    function SPFbExplain() {
        var _this = _super.call(this) || this;
        _this.imgItem = [];
        _this._topUI = new TopUI("超级足彩玩法介绍");
    ...
    Object.defineProperty(SPFbExplain, "getInstance", {
        get: function () {
            if (SPFbExplain._mInstance == undefined)
                SPFbExplain._mInstance = new SPFbExplain();
            return SPFbExplain._mInstance;
        },
        enumerable: true,
        configurable: true
    });
    SPFbExplain.prototype.touchDown = function (e) {
        if (e.target == this._return) {
            this.hide();
        }
    };
    SPFbExplain.prototype.show = function () {
        GUIManager.getInstance.tipLay.addChild(this);
        this._return.addEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
    };
    SPFbExplain.prototype.hide = function () {
    ...
    SPFbExplain.prototype.addScoll = function () {
    ...
    /**适配处理 */
    SPFbExplain.prototype.setDB = function () {
...
__reflect(SPFbExplain.prototype, "SPFbExplain");
//# sourceMappingURL=SPFbExplain.js.map