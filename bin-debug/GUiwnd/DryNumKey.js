...
/**发单数字键盘 */
var DryNumKey = (function (_super) {
    __extends(DryNumKey, _super);
    function DryNumKey() {
        var _this = _super.call(this) || this;
        _this._str = "1";
        _this.topStr = [1, 3, 5, 8, 10];
    ...
    Object.defineProperty(DryNumKey, "getInstance", {
        get: function () {
    ...
    DryNumKey.prototype.setTop = function (num) {
    ...
    //保存按钮
    DryNumKey.prototype.setBtn = function (num) {
        var a = this._str + num.toString();
    ...
    DryNumKey.prototype.changeCss = function () {
        // this._strText.text = `盈利提成${this._str}%`;
        this._strText.textFlow = [
    ...
    /**NumKeyData */
    DryNumKey.prototype.show = function (mData) {
    ...
    DryNumKey.prototype.hide = function () {
        if (this.parent != undefined) {
    ...
    DryNumKey.prototype.touchDown = function (e) {
    ...
    DryNumKey.prototype.addEvent = function () {
    ...
    DryNumKey.prototype.removeEvent = function () {
    ...
    DryNumKey.prototype.init = function () {
        var _this = this;
    ...
    /**适配处理 */
    DryNumKey.prototype.setDB = function () {
...
__reflect(DryNumKey.prototype, "DryNumKey");
/**头部info按钮模块 */
var DryNumKeyTopInfo = (function (_super) {
    __extends(DryNumKeyTopInfo, _super);
    function DryNumKeyTopInfo(num) {
        var _this = _super.call(this) || this;
        _this._num = num;
        ...
        _this._shapeText.text = num + "%";
        _this._shapeText.touchEnabled = true;
        return _this;
    }
    DryNumKeyTopInfo.prototype.touchDown = function (e) {
        DryNumKey.getInstance.setTop(this._num);
    };
    DryNumKeyTopInfo.prototype.addEvent = function () {
        this._shapeText.addEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
    };
    DryNumKeyTopInfo.prototype.removeEvent = function () {
        this._shapeText.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.touchDown, this);
    };
    return DryNumKeyTopInfo;
}(egret.DisplayObjectContainer));
__reflect(DryNumKeyTopInfo.prototype, "DryNumKeyTopInfo");
/** 0~9按钮 */
var DryNumKeyBtnInfo = (function (_super) {
    __extends(DryNumKeyBtnInfo, _super);
    function DryNumKeyBtnInfo(num, width) {
        var _this = _super.call(this) || this;
        _this._num = num;
        _this._width = width;
        _this._shape = new egret.Shape();
    ...
    DryNumKeyBtnInfo.prototype.addEvent = function () {
    ...
    DryNumKeyBtnInfo.prototype.removeEvent = function () {
    ...
    return DryNumKeyBtnInfo;
}(egret.DisplayObjectContainer));
__reflect(DryNumKeyBtnInfo.prototype, "DryNumKeyBtnInfo");
//# sourceMappingURL=DryNumKey.js.map